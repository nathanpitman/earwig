...
class GoogleCharts {
	...
	var $barWidth='26'; //sets the width of the bars for vert/horiz bar charts.
	...
	function draw($append='&amp;chxr.png') {
		...
		$return.='&amp;chxr=';
		return '<img class="googleChart" src="'.$return.$append.'" alt="" />';
	}
